...
module.exports = async function whitelistMenu(client, interaction) {
  ...
  const embed = new EmbedBuilder()
    .setTitle("📋 Módulo Whitelist")
    .setColor(0xf1c40f)
    .setDescription("Administra solicitudes, aprobados, pendientes y exportaciones.")
    .addFields(
  ...
  const fila2 = new ActionRowBuilder().addComponents(
    new ButtonBuilder().setCustomId("panel_exportar").setLabel("Exportar").setEmoji("📁").setStyle(ButtonStyle.Primary),
